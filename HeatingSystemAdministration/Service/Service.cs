...
namespace HeatingSystemAdministration.Service
{
    class Service
    {
        ...
        {
            Customer c1 = new Customer() { Number = "00001", Name="Cristian Leahu", Address="Fynsgade", Meters = new List<Model.Meter>() };
            ...
            Customer c2 = new Customer() { Number = "00002", Name = "Benn", Address = "School", Meters = new List<Model.Meter>() };
            Model.Meter m2 = new Model.Meter() { Number = "00003", Amount = "2324", Customer = c2, Year = new DateTime(2017, 1, 18) };
            c2.AddMeter(m2);

            Customer c3 = new Customer() { Number = "00003", Name = "Donald Trump", Address = "White house", Meters = new List<Model.Meter>() };
            Model.Meter m3 = new Model.Meter() { Number = "00004", Amount = "11983", Customer = c3, Year = new DateTime(2017, 1, 18) };
            c3.AddMeter(m3);

            Customer c4 = new Customer() { Number = "00004", Name = "Hilary Clinton", Address = "No house", Meters = new List<Model.Meter>() };
